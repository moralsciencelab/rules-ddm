...
var test_stimuli_shoes = [
  ...
  },
  {
    ...
    data: { stim_type: "congruent", correct_response: "No" },
  },
  {
...
var test_stimuli_lab = [
  ...
  {
    stimulus: `To avoid accidents, the director of a scientific laboratory issued a rule:<br> "Access for laboratory personnel only"<br><br><br><b>A member of the public stands outside the laboratory without entering.</b><br>`, // problem item1 walks past the laboratory while going home
    data: { stim_type: "congruent", correct_response: "No" },
  },
  {
    stimulus: `To avoid accidents, the director of a scientific laboratory issued a rule:<br> "Access for laboratory personnel only"<br><br><br><b>A tourist admires the laboratory from across the street.</b><br>`, // problem item1:  walks past the laboratory on his way to the wax museum
    data: { stim_type: "congruent", correct_response: "No" },
  },
  {
